...
class MyGridLayout(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.grid_01.ub_lab = Label(text = "", font_size = 12)
        self.grid_01.ub_button = Button(text ="UPPER")
        ...
        self.grid_01.lb_lab = Label(text = "", font_size = 12)
        self.grid_01.lb_button = Button(text ="LOWER")
        ...
        self.grid_01.cb_lab = Label(text = "", font_size = 12)
        self.grid_01.cb_button = Button(text ="CORE")
        ...
        # Add all body button
        self.grid_01.f3_lab = Label(text = "", font_size = 12)
        self.grid_01.f3_button = Button(text ="ALL")
        ...
        self.grid_02 = GridLayout(size_hint_y = 0.25)
        ...
        self.grid_02.list_but = Button(text = "SUBMIT")
        self.grid_02.list_but.bind(on_press = self.rest_chance_fun)
        self.grid_02.list_txt = TextInput()
        # add widgets
        ...
        self.clear_button_01 = Button(text = "CLEAR WORKOUTS", font_size = 22, size_hint_y = 0.25)
